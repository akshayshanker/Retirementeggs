...
with open('deterministic_params_lite.csv', newline='') as pscfile:
...
lambdas  			= genfromtxt('lambdas.csv', delimiter=',')[1:]
survival 			= genfromtxt('survival_probabilities.csv', delimiter=',')[0:]
vol_cont_points 	= genfromtxt('vol_cont_points_lite.csv', delimiter=',')[1:]
...
pickle.dump(og, open("/scratch/pv33/results_paramset_baseline_l.mod","wb"))
